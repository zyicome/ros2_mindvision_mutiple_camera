...
public:
  explicit MVCameraNode(const rclcpp::NodeOptions & options) : Node("mv_camera", options)
  {
    ...
    leftcamera_pub_ = image_transport::create_camera_publisher(this, "image_left", qos);
    rightcamera_pub_ = image_transport::create_camera_publisher(this, "image_right", qos);
